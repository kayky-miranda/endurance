...
export const PERMISSIONS: PermissionDef[] = [
  ...
  },
  {
    ...
    description: "Cadastrar e editar a ficha do paciente, convênio e documentos.",
    group: "Operação",
  },
  {
    id: "prontuario.manage",
    label: "Prontuário clínico",
    description:
      "Ver e registrar anotações clínicas confidenciais dos pacientes.",
    group: "Operação",
  },
  {
    id: "evolucao.manage",
    label: "Evolução do paciente",
    description: "Registrar e acompanhar medições (peso, medidas, escalas).",
    group: "Operação",
  },
  {
    id: "planos.manage",
