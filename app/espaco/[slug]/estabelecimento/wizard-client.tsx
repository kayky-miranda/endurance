  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[260px_1fr]">
      ...
      <div className="space-y-4">
        ...
        {/* Ressalvas da etapa: o menu marcava ⚠️ e o formulário não dizia por
            quê — o cliente ficava com a etapa amarela sem saber o que resolver.
            Não bloqueiam, então o tom é de recomendação. */}
        {etapaAtual && etapaAtual.blocking.length === 0 && etapaAtual.warnings.length > 0 && (
          <div className="rounded-xl border border-amber-300 bg-amber-50 px-4 py-3 text-sm text-amber-900 dark:border-amber-800 dark:bg-amber-950/40 dark:text-amber-200">
            <p className="font-medium">Recomendado (não impede emitir):</p>
            <ul className="mt-1 list-inside list-disc">
              {etapaAtual.warnings.map((w) => (
