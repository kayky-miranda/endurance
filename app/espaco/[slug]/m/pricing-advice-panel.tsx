...
import { pricingAdviceAction } from "./reports-actions";
...
export default function PricingAdvicePanel() {
  ...
  async function load() {
    setLoading(true);
    const res = await pricingAdviceAction();
    if (res.ok) {
      setItems(res.tips);
