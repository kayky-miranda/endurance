...
import { searchPatientsAction, type PatientHit } from "./planos-actions";

/** Busca de paciente para abrir/criar planos alimentares. */
            ...
            hits.map((h) => (
              <li key={h.id}>
                <button
                  type="button"
                  onClick={() =>
                    router.push(`/espaco/${slug}/m/planos_alimentares/${h.id}`)
                  }
