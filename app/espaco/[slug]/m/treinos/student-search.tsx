...
import { searchStudentsAction, type StudentHit } from "./treinos-actions";

/** Busca de aluno para abrir/criar fichas de treino. */
          ...
          {hits.length === 0 ? (
            ...
            hits.map((h) => (
              <li key={h.id}>
                <button
                  type="button"
                  onClick={() => router.push(`/espaco/${slug}/m/treinos/${h.id}`)}
