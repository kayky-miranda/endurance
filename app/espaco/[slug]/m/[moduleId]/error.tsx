...
/** Boundary de erro de um módulo — o resto do espaço continua navegável. */
export default function ModuleError({
  ...
  useEffect(() => {
    console.error(`[error-boundary:modulo:${params.moduleId}]`, error);
  }, [error, params.moduleId]);
    ...
    <div className="grid place-items-center rounded-2xl border border-slate-200 bg-white px-6 py-16 text-center shadow-sm dark:border-ink-700 dark:bg-ink-900">
      <div className="max-w-md">
        ...
        <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
          O restante do espaço segue funcionando. Tente recarregar o módulo.
          {error.digest && (
