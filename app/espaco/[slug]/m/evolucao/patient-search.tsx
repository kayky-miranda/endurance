...
import { searchPatientsAction, type PatientHit } from "./evolucao-actions";

/** Busca de paciente para abrir/iniciar o acompanhamento de evolução. */
          ...
          {hits.length === 0 ? (
            ...
            hits.map((h) => (
              <li key={h.id}>
                <button
                  type="button"
                  onClick={() => router.push(`/espaco/${slug}/m/evolucao/${h.id}`)}
