...
import { searchPatientsAction, type PatientHit } from "./prontuario-actions";

/**
 * Busca de paciente para abrir/iniciar um prontuário. Digitou 2+ letras,
 * consulta o servidor (debounce) e navega para o prontuário do escolhido.
 */
            ...
            hits.map((h) => (
              <li key={h.id}>
                <button
                  type="button"
                  onClick={() =>
                    router.push(`/espaco/${slug}/m/prontuario/${h.id}`)
                  }
